...
{{< include include/code/_lotus3.qmd >}}
...
{{< include include/data/_lotus3_output_amf.qmd >}}
...
{{< include include/data/_lotus3_output_oo.qmd >}}
...
#| echo: false
#| eval: true
#| label: tbl-make-pipeline-table-amf
#| tbl-cap: "Read changes through the LotuS3 pipeline."
tmp_react <- amf_rc
make_lotus3_summ_table(tmp_react)
```
...
#| echo: false
#| eval: true
#| label: tbl-make-pipeline-table-oo
#| tbl-cap: "Read changes through the LotuS3 pipeline."
tmp_react <- oo_rc
make_lotus3_summ_table(tmp_react)
```
