...
| Dataset         | Currated Data (zip files)                                                                                                               |  Read changes (.txt file)
|-----------------|:---------------------------------------------------------------------------------------------------------------------------------------:|:---------------------------------------------------------------------------------------------------------------------------------------------------:|
| 16S rRNA (ssu)  | {{< downloadthis files/SHARE/ssu_curated_data.zip dname="ssu_curated_data" label="ssu_curated_data" icon="download"  type="link" >}}    | {{< downloadthis files/SHARE/ssu_track_read_counts.txt dname="ssu_track_read_counts" label="ssu_track_read_counts" icon="download" type="link" >}}  |
| ITS (its)       | {{< downloadthis files/SHARE/its_curated_data.zip dname="its_curated_data" label="its_curated_data" icon="download" type="link" >}}     | {{< downloadthis files/SHARE/its_track_read_counts.txt dname="its_track_read_counts" label="its_track_read_counts" icon="download" type="link" >}}  |
| AMF (amf)       | {{< downloadthis files/SHARE/amf_curated_data.zip dname="amf_curated_data" label="amf_curated_data" icon="download"  type="link" >}}    | {{< downloadthis files/SHARE/amf_track_read_counts.txt dname="amf_track_read_counts" label="amf_track_read_counts" icon="download" type="link" >}}  |
| Oomycete (oo)   | {{< downloadthis files/SHARE/oo_curated_data.zip dname="oo_curated_data" label="oo_curated_data" icon="download" type="link" >}}        | {{< downloadthis files/SHARE/oo_track_read_counts.txt dname="oo_track_read_counts" label="oo_track_read_counts" icon="download" type="link" >}}     |
