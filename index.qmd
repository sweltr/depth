...
{{< downloadthis files/SHARE/ssu_curated_data.zip dname="ssu_curated_data" label="ssu_curated_data.zip" icon="download"  type="link" >}}   &nbsp; {{< downloadthis files/SHARE/its_curated_data.zip dname="its_curated_data.zip" label="its_curated_data.zip" icon="download" type="link" >}}

{{< downloadthis files/SHARE/amf_curated_data.zip dname="amf_curated_data" label="amf_curated_data.zip" icon="download"  type="link" >}}   &nbsp; {{< downloadthis files/SHARE/oo_curated_data.zip dname="oo_curated_data.zip" label="oo_curated_data.zip" icon="download" type="link" >}}


These `.zip` files contains the processed data in different formats:
