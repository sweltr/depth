...
| Dataset         | Curated Data (zip files)                                                                                                                |  Read changes (.txt file)
|-----------------|:---------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------:|
| 16S rRNA (ssu)  | {{< downloadthis files/SHARE/ssu_curated_data.zip dname="ssu_curated_data" label="ssu_curated_data" icon="file-zip"  type="link" >}}    | {{< downloadthis files/SHARE/ssu_track_read_counts.txt dname="ssu_track_read_counts" label="ssu_track_read_counts" icon="table" type="link" >}}  |
| ITS (its)       | {{< downloadthis files/SHARE/its_curated_data.zip dname="its_curated_data" label="its_curated_data" icon="file-zip" type="link" >}}     | {{< downloadthis files/SHARE/its_track_read_counts.txt dname="its_track_read_counts" label="its_track_read_counts" icon="table" type="link" >}}  |
| AMF (amf)       | {{< downloadthis files/SHARE/amf_curated_data.zip dname="amf_curated_data" label="amf_curated_data" icon="file-zip"  type="link" >}}    | {{< downloadthis files/SHARE/amf_track_read_counts.txt dname="amf_track_read_counts" label="amf_track_read_counts" icon="table" type="link" >}}  |
| Oomycete (oo)   | {{< downloadthis files/SHARE/oo_curated_data.zip dname="oo_curated_data" label="oo_curated_data" icon="file-zip" type="link" >}}        | {{< downloadthis files/SHARE/oo_track_read_counts.txt dname="oo_track_read_counts" label="oo_track_read_counts" icon="table" type="link" >}}     |

: Quick links to curated data. {tbl-colwidths="[26,37,37]"}
...
The `xyz_track_read_counts` tables listed above **include read tracking through the entire workflow**.
...
{{< downloadthis files/SHARE/all_samples_final_counts.txt dname=all_samples_final_counts label="Download final read/ASV counts in all datasets" icon=table type=link class=data-button id=all_samples_final_counts >}}
...
### {{< fa download >}} &nbsp; LotuS3 phyloseq objects 

{{< downloadthis files/CURATE/phyloseq_ssu.Rdata dname="phyloseq_ssu" label="16S rRNA LotuS3 phyloseq data" icon="database" type="link" >}} For a more detailed explanation please see the [SSU Data Curation](curate_ssu.qmd) workflow. 


{{< downloadthis files/CURATE/phyloseq_its.Rdata dname="phyloseq_its" label="ITS LotuS3 phyloseq data" icon="database" type="link" >}} For a more detailed explanation please see the [ITS Data Curation](curate_its.qmd) workflow. 


{{< downloadthis files/CURATE/phyloseq_amf.Rdata dname="phyloseq_amf" label="AMF LotuS3 phyloseq data" icon="database" type="link" >}} For a more detailed explanation please see the [AMF Data Curation](curate_amf.qmd) workflow. 


{{< downloadthis files/CURATE/phyloseq_oo.Rdata dname="phyloseq_oo" label="Oomycete LotuS3 phyloseq data" icon="database" type="link" >}} For a more detailed explanation please see the [Oomycete Data Curation](curate_oo.qmd) workflow. 
