...
save.image("CUTADAPT/rdata/1.1_setup_amf.rdata")
...
#ggsave("figures/amf_plot_qscores_pre_filt.png", p3b, width = 7, height = 3)
...
ggsave("CUTADAPT/figures/amf_plot_qscores_cut.png", p3_cut, width = 7, height = 3)
...
save.image("CUTADAPT/rdata/1.2_cutadapt_amf.rdata")
